...
<ol class="breadcrumb">
    <li>首页</li>
    <li class="active" id="route">我的帖子</li>
</ol>
<div class="panel-body">
    <div class="clearfix" style="min-height: 200px;">
        <div id="as-content-panel" class="text-center">
            <table id="my-post-list" class="table table-default">
                <thead>
                    <tr>
                        <th class="text-center">帖子编号</th>
                        <th class="text-center">版块</th>
    ...
    <!-- 底部版权 -->
    <div id="footer">
    	我的帖子 @ 柯灰kohai 版权所有 <span class="hidden-xs"> Mail:916309979@qq.com <a href="__ROOT__/admin.html" title="管理网站" style="color: green;background-color: white;">管理网站</a></span>
    </div>
    <!-- 底部版权结束 -->
    <!-- 悬浮工具条 -->
...
<script src="__STATIC__/js/index/user/post.js"></script>
</body>
