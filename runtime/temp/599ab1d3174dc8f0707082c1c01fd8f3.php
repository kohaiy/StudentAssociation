<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\git\StudentAssociation\public/../application/index\view\user\register.html";i:1497938575;s:75:"E:\git\StudentAssociation\public/../application/index\view\common\base.html";i:1499060521;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
    <div class="panel panel-primary">
        <div class="panel-heading">用户注册中心</div>
        <div class="panel-body">
            <form id="regForm" method="post" action="">
                ...
                <div class="form-group has-feedback">
                    <label class="control-label" for="password2">验证密码</label>
                    <input type="password" class="form-control" id="password2" placeholder="请再次输入密码">
                    <span id="password2Icon" class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    <span id="password2Hint" class="help-block"></span>
                </div>
                <a href="__ROOT__/index/user/login.html" class="btn btn-default">登录</a>
    ...
    <!-- 底部版权 -->
    <div id="footer">
    	用户注册中心 @ 柯灰kohai 版权所有 <span class="hidden-xs"> Mail:916309979@qq.com <a href="__ROOT__/admin.html" title="管理网站" style="color: green;background-color: white;">管理网站</a></span>
    </div>
    <!-- 底部版权结束 -->
    <!-- 悬浮工具条 -->
    ...
    <script src="__STATIC__/js/index/user/register.js"></script>
</body>
