<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"E:\git\StudentAssociation\public/../application/index\view\post\edit.html";i:1499009740;s:75:"E:\git\StudentAssociation\public/../application/index\view\common\base.html";i:1499060521;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
        ...
        <div class="panel-body">
            <form action="" method="post" id="myForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" id="title" placeholder="帖子标题" value="<?php echo $post['title']; ?>">
                </div>
                <div class="form-group">
                    <label for="contents">帖子内容</label>
                    <script id="editor" name="content" type="text/plain" style="width:100%;height:200px;"><?php echo $post['content']; ?></script>
                </div>
                <div class="form-group">
                    <label for="tags">帖子标签 <small id="helpBlock" class="text-info"><abbr title="多个标签使用空格分割。" class="initialism">帮助</abbr></small></label>
                    <input type="text" name="tags" class="form-control" id="tags" placeholder="帖子标签" value="<?php echo $post['tags']; ?>">
                    
                    <div id="tags-show" class=help-block></div>
                </div>
                <div class="form-group">
                    <input type="submit" class="btn btn-success" id="submit" value="修改帖子">
                </div>
            </form>
        </div>
    </div>
    ...
    <!-- 底部版权 -->
    <div id="footer">
    	帖子编辑 @ 柯灰kohai 版权所有 <span class="hidden-xs"> Mail:916309979@qq.com <a href="__ROOT__/admin.html" title="管理网站" style="color: green;background-color: white;">管理网站</a></span>
    </div>
    <!-- 底部版权结束 -->
    <!-- 悬浮工具条 -->
