<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\git\StudentAssociation\public/../application/\common\view\dispatch_jump.tpl";i:1498886661;s:75:"E:\git\StudentAssociation\public/../application/index\view\common\base.html";i:1499060521;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<head>
    ...
    <title><?php echo(explode('|',strip_tags($msg).'|')[0]);?> - 跳转提示 - 同乡网</title>
...
<body class="bg-success">
    ...
    <div class="system-message">
        <?php switch ($code) {case 1:?>
            <h1>:)</h1>
            <p class="success"><?php echo(explode('|',strip_tags($msg).'|')[0]);?></p>
            <?php break;case 0:?>
            <h1>:(</h1>
            <p class="error"><?php echo(explode('|',strip_tags($msg).'|')[0]);?></p>
            <?php break;} ?>
        <p class="detail"><?php echo(explode('|',strip_tags($msg).'|')[1]);?></p>
        <p class="jump">
