<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"E:\git\StudentAssociation\public/../application/index\view\square\index.html";i:1498914669;s:75:"E:\git\StudentAssociation\public/../application/index\view\common\base.html";i:1499060521;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="__STATIC__/css/index/square/index.css">
    <!--[if lt IE 9]>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="__ROOT__/index/square.html">广场</a></li>
                </ul>
...
<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有版块！" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <div class="col-md-6">
        <div class="panel panel-default panel-black">
        	<div class="panel-heading"><a href="__ROOT__/index/board.html?id=<?php echo $vo['id']; ?>" title="<?php echo $vo['name']; ?>" class="glyphicon glyphicon-comment"> <?php echo $vo['name']; ?></a></div>
        	<div class="panel-body board-item" id="<?php echo $vo['id']; ?>">
            	内容加载中...
        	</div>
        </div>
    </div>
<?php endforeach; endif; else: echo "暂时没有版块！" ;endif; ?>
</div>
<div class="col-sm-3 col-md-2">
    <div class="panel panel-default panel-black">
        <div class="panel-heading">
            <span class="glyphicon glyphicon-tags"> 标签墙</span> <abbr title="标签越大，内容越多" class="glyphicon glyphicon-question-sign small"></abbr>
        </div>
        <div id="tagsWall" class="panel-body">
            内容加载中...
        </div>
    </div>
</div>
    ...
    <!-- 底部版权 -->
    <div id="footer">
    	广场 @ 柯灰kohai 版权所有 <span class="hidden-xs"> Mail:916309979@qq.com <a href="__ROOT__/admin.html" title="管理网站" style="color: green;background-color: white;">管理网站</a></span>
    </div>
    <!-- 底部版权结束 -->
    <!-- 悬浮工具条 -->
    ...
    <script src="__STATIC__/js/index/square/index.js"></script>
</body>
