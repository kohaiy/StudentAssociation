<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"E:\git\StudentAssociation\public/../application/index\view\board\index.html";i:1497975704;s:75:"E:\git\StudentAssociation\public/../application/index\view\common\base.html";i:1499060521;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<head>
    ...
    <title><?php echo $board['name']; ?> - 同乡网</title>
...
<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
	<div class="panel panel-info">
		<div class="panel-heading clearfix">
  			<a href="__ROOT__/index/post/send.html?bid=<?php echo $board['id']; ?>" class="btn btn-success">发表帖子</a>
		</div>
		<ol class="breadcrumb">
			...
			<li class="active"><?php echo $board['name']; ?></li>
		</ol>
 		<div class="panel-body">
 		<?php if($list == null): ?>
 			<div class="text-center">
 				当前还没有帖子，赶紧发表一个吧！<a href="__ROOT__/index/post/send.html?bid=<?php echo $board['id']; ?>" class="text-info">发表帖子</a>
 			</div>
 		<?php else: ?>
			...
			<tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "没有帖子！" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr>
					<td class="hidden-xs"><?php echo $vo['pid']; ?></td>
					<td><a href="__ROOT__/index/post.html?id=<?php echo $vo['pid']; ?>" title="<?php echo $vo['title']; ?>"><?php echo $vo['title']; ?></a></td>
    ...
    <!-- 底部版权 -->
    <div id="footer">
    	版块中心 @ 柯灰kohai 版权所有 <span class="hidden-xs"> Mail:916309979@qq.com <a href="__ROOT__/admin.html" title="管理网站" style="color: green;background-color: white;">管理网站</a></span>
    </div>
    <!-- 底部版权结束 -->
    <!-- 悬浮工具条 -->
