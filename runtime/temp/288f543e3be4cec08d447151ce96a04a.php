<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"E:\git\StudentAssociation\public/../application/index\view\notice\add.html";i:1498982651;s:75:"E:\git\StudentAssociation\public/../application/index\view\common\base.html";i:1499060521;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
    <div class="panel panel-default panel-black">
        ...
        <div class="panel-body">
            <div>
                <a href="__ROOT__/index/notice/manager.html" class="btn btn-success">查看公告</a>
            </div>
            <div>
                <form method="post">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" class="form-control" placeholder="公告内容"></textarea>
                    </div>
                    <!-- <div class="form-group">
                        <label for="start">开始时间</label>
                        <input class="form-control" name="start" id="start" type="text" placeholder="请选择" readonly>
                    </div>
                    <div class="form-group">
                        <label for="start">结束时间</label>
                        <input class="form-control" name="stop" id="stop" type="text" placeholder="请选择" readonly>
                    </div> -->
                    <div class="form-group">
                        <input class="form-control btn btn-success" type="submit" value="确认添加">
                    </div>
                </form>
            </div>
        </div>
    ...
    <!-- 底部版权 -->
    <div id="footer">
    	 @ 柯灰kohai 版权所有 <span class="hidden-xs"> Mail:916309979@qq.com <a href="__ROOT__/admin.html" title="管理网站" style="color: green;background-color: white;">管理网站</a></span>
    </div>
    <!-- 底部版权结束 -->
    <!-- 悬浮工具条 -->
...
<script src="__STATIC__/jeDate/jedate.js"></script>
<script src="__STATIC__/js/index/notice/add.js"></script>
</body>
