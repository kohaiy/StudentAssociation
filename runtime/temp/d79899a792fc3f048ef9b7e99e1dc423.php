<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"E:\git\StudentAssociation\public/../application/index\view\user\login.html";i:1498205066;s:75:"E:\git\StudentAssociation\public/../application/index\view\common\base.html";i:1499060521;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
    <div class="panel panel-primary">
        <div class="panel-heading">用户登录中心</div>
        <div class="panel-body">
            <form id="loginForm" method="post" action="">
                ...
                <a href="__ROOT__/index/user/register.html" class="btn btn-default">注册</a>
    ...
    <!-- 底部版权 -->
    <div id="footer">
    	用户登录中心 @ 柯灰kohai 版权所有 <span class="hidden-xs"> Mail:916309979@qq.com <a href="__ROOT__/admin.html" title="管理网站" style="color: green;background-color: white;">管理网站</a></span>
    </div>
    <!-- 底部版权结束 -->
    <!-- 悬浮工具条 -->
    ...
    <script src="__STATIC__/js/index/user/login.js"></script>
</body>
